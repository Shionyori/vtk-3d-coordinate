...
public:
    Arrow();
    Arrow(double origin[3], double target[3], int coneCount = 1, double color[3] = nullptr, double lineWidth = 1.5);
    void CreateArrow(double origin[3], double target[3], int coneCount = 1, double color[3] = nullptr, double lineWidth = 1.5);
